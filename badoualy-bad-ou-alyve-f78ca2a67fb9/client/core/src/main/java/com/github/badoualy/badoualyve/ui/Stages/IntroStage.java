...
public class IntroStage extends Stage {
    ...
    private void initActors() {
        ...
        if(GlobalSettings.USE_SERVER) {
            ...
            for (int i = 0; i < _ge.getPartie().listUser.size(); i++) {

                if (i == 0) {
                    userMod1 = new StatModule(_ge.getPartie().listUser.get(i).name);
                    userMod1.setPosition(GlobalSettings.PLACE_X_MOD_USER, yLine);
                    userMod1.SetInfo(_ge.getPartie().listUser.get(i).score, _ge.getPartie().listUser.get(i).lines);
                    addActor(userMod1);
                }
                ...
                if (i == 1) {
                    ...
                    userMod2.SetInfo(_ge.getPartie().listUser.get(i).score, _ge.getPartie().listUser.get(i).lines);
                    addActor(userMod2);
                }
                ...
                if (i == 2) {
                    ...
                    userMod3.SetInfo(_ge.getPartie().listUser.get(i).score, _ge.getPartie().listUser.get(i).lines);
                    addActor(userMod3);
                }
                ...
                if (i == 3) {
                    ...
                    userMod4.SetInfo(_ge.getPartie().listUser.get(i).score, _ge.getPartie().listUser.get(i).lines);
                    addActor(userMod1);
                }
        ...
        if (_isAnimate) {
            if (_colAnimate < GlobalSettings.SIZE_ARRAY_X) {
                ...
                if (_indexEncours == 0) {
                    ...
                    _ligneAnimate = 0;
                    _colAnimate = 0;
                    //int x=_ge.GetLineAnimate().size();
                    _ge.setNumberLine(String.valueOf(_ge.GetLineAnimate().size()));
                    _ge._deleteLine();
                    if(GlobalSettings.USE_SERVER) {
