...
public class HomeStage extends Stage {
    ...
    private Button _buttonClientorServer;
    InputText _input;
    ...
    public HomeStage(GameEngine ge) {
       ...
       _inputServer = new InputText("Status");
        ...
        _buttonClientorServer = new Button("Multi");
        _buttonClientorServer.setPosition(80, 150);
        addActor(_buttonClientorServer);
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if(_buttonClientorServer.OnClick(screenX, screenY)){

            GlobalSettings.USE_SERVER = !GlobalSettings.USE_SERVER;
            if(!GlobalSettings.USE_SERVER) _buttonClientorServer.set_label("Multi"); else _buttonClientorServer.set_label("SOLO");
            System.out.println("yeeeeeeeee" + GlobalSettings.USE_SERVER);
